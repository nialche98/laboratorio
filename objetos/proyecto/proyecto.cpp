...
//___________________________________________
void cliente::set(string apellido_){
	 apellido= apellido_;
}
//___________________________________________
void cliente::set(string fecha_){
	fechaN=fecha_ ;
}
//___________________________________________
void cliente::set(string sexo_){
	sexo=sexo_;
}
//___________________________________________
void cliente::set(string civil_){
	Ecivil=civil_;
}
//___________________________________________
void cliente::set(int cedula_){
	cedula=cedula_;
}
//___________________________________________
void cliente::set(string direccion_){
	direccion= direccion_;
}
//___________________________________________
void cliente::set(int telefono_){
	telefono= telefono_;
}
//___________________________________________
void cliente::set(int celular_){
	 celular= celular_;
}
//___________________________________________
void cliente::set(string correo_){
	 correo= correo_;
}
...
void Empleado::contactarcliente(){
	cout<<"el empleado llama al cliente a verificar los datos mal dados"<<end;
}
//___________________________________________
...
//___________________________________________
void Carrito::ingresardatastarjeta(){
