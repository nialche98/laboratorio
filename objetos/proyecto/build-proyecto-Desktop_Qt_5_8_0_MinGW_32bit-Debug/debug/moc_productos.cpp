...
struct qt_meta_stringdata_productos_t {
    QByteArrayData data[5];
    char stringdata0[83];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_productos_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_productos_t qt_meta_stringdata_productos = {
    {
QT_MOC_LITERAL(0, 0, 9), // "productos"
...
QT_MOC_LITERAL(4, 59, 23) // "on_pushButton_8_clicked"
    ...
    "productos\0on_pushButton_7_clicked\0\0"
...
void productos::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        productos *_t = static_cast<productos *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject productos::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_productos.data,
      qt_meta_data_productos,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *productos::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_productos.stringdata0))
